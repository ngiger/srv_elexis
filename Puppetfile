...
#mod "garethr/docker", :git => 'https://github.com/ngiger/garethr-docker.git', :ref => 'jessie'


# mod 'danzilio/letsencrypt' not satifsied, no nginx
# mod 'pgassmann/letsencrypt'

mod 'puppetlabs/git'
mod 'puppetlabs/vcsrepo'
# mod 'garystafford/docker_compose'

mod 'ngiger/srv_elexis',     :path => './static-modules/srv_elexis'
